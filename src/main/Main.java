...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("No. of Inst Hits = "+Statistics.getNoOfInstHits());
		System.out.println("No. of Inst Acceses = "+Statistics.getNoOfInstAccesses());
		System.out.println("No. of Memory Hits = "+Statistics.getNoOfMemoryHits());
		System.out.println("No. of Memory Acceses = "+Statistics.getNoOfMemoryAccesses());
	}
